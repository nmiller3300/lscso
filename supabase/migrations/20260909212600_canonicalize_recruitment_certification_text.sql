...
begin
  ...
  if btrim(coalesce(p_certification_text, '')) <> v_certification_text then
  ...
  set ai_policy_acknowledged = true,
      ...
      applicant_certification_text = v_certification_text
