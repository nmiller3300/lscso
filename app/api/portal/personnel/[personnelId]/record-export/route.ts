...
const evaluationLabels:Record<string,string>={professional_conduct:"Professional Conduct",policy_knowledge:"Policy Knowledge",communication:"Communication",judgment_decision_making:"Judgment & Decision-Making",report_documentation:"Reports & Documentation",officer_safety_tactics:"Officer Safety & Tactics",initiative_reliability:"Initiative & Reliability",teamwork_leadership:"Teamwork & Leadership"};
