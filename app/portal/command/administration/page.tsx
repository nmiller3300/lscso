...
export default async function AdministrationWorkspacePage() {
  ...
  const tools: AdminTool[] = [
    ...
    { href: "/portal/command/administration/open-records", code: "OR", eyebrow: "Public records", title: "Open Records Requests", description: "Review public records requests, document release decisions, and manage the Georgia/San Andreas response workflow.", group: "Department Governance" },
