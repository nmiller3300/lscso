    ...
    <div className="open-records-custodian-controls">
      ...
      <section className="open-records-custodian-section">
        ...
        <div className="open-records-custodian-grid">
          ...
          <label className="is-wide">Legal authority for withholding / redaction<textarea value={withholdingAuthority} onChange={(event) => setWithholdingAuthority(event.target.value)} rows={2} maxLength={4000} placeholder="Required for partial grants and denials. Cite the applicable OCSA section or other controlling San Andreas authority." /></label>
