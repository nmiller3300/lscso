...
for(const relative of files){
  ...
  if(relative.endsWith(".tsx")&&relative!=="app/portal/_components/PortalDialog.tsx"&&/portal-modal-backdrop/.test(source))errors.push(`${relative}: Legacy modal backdrop remains; migrate this workflow to PortalDialog.`);
